...
#os.system("thor xcs:add Classes/TouchlsSynthesis.m Classes")\
...
\
targ=raw_input("Type name of target in xcodeproj file and press enter")\
\
os.system("xcodebuild -configuration Debug -target "+targ+" -sdk iphonesimulator4.2 HEADER_SEARCH_PATHS=$SDKROOT/usr/include/libxml2"\
\
os.chdir(start_dir)\
\
os.system(build/Release/iphonesim launch <PROJECT_DIR_ROOT/build/Debug-iphonesimulator/APP_NAME>\
\
\
}